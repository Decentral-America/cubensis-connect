...
1. Complete **Phase 1** (1-BULLETPROOF.md) — all quality gates passing.
2. Complete **Phase 2** (2-MODERNIZE.md) — fully modernized, rebranded, ESM-native.
...
- [ ] `@typescript-eslint/no-unused-vars: 'error'` with `varsIgnorePattern: '^_'`
- [ ] `no-console: ['warn', { allow: ['warn', 'error'] }]`
- [ ] `eslint-config-prettier` is the last config (prevents formatting rule conflicts)
- [ ] No stale rule overrides (e.g., rules for plugins that are no longer installed)
