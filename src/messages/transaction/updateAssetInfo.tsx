  ...
  return (
    <div className={clsx(transactionsStyles.transactionCard, className)}>
      <div className={transactionsStyles.cardHeader}>
        ...
        <div>
          <div className="basic500 body3 margin-min">{t('transactions.updateAssetInfo')}</div>
        </div>
      </div>
    </div>
  );
        ...
        <TxDetailTabs json={stringifyTransaction(message.data, { pretty: true })}>
          <div>
            <div className={transactionsStyles.txRow}>
              <div className="tx-title tag1 basic500">{t('transactions.assetId')}</div>

              <div className={transactionsStyles.txValue} data-testid="updateAssetInfoAssetId">
                {tx.assetId}
              </div>
            </div>
            ...
            <div className={transactionsStyles.txRow}>
              ...
              <div className={transactionsStyles.txValue} data-testid="updateAssetInfoAssetName">
                {tx.name}
              </div>
            </div>
