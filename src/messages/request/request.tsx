        ...
        {collapsed ? (
          <div className={styles.smallCardContent}>
            ...
            <div>
              ...
              <h1 className="headline1">{t('transactions.signRequestMatcher')}</h1>
            </div>
          </div>
        ) : (
    ...
    <div className={transactionsStyles.transaction}>
      ...
      <div className={clsx(transactionsStyles.txScrollBox, 'transactionContent')}>
        ...
        <div className={transactionsStyles.txRow}>
          <div className="tx-title body3 basic500">{t('transactions.matcherTimeStamp')}</div>

          <div className={transactionsStyles.txValue}>{message.data.data.timestamp}</div>
        </div>
