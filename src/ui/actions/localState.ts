import { type SwapScreenInitialState } from 'ui/reducers/localState';
...
export const notificationDelete = createMVAction<boolean>(ACTION.NOTIFICATION_DELETE);
export const notificationSelect = createMVAction<boolean>(ACTION.NOTIFICATION_SELECT);
export const notificationChangeName = createMVAction<boolean>(ACTION.NOTIFICATION_NAME_CHANGED);
...
export function setSwapScreenInitialState(initialState: SwapScreenInitialState) {
  return {
