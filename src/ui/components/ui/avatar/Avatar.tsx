  ...
  render() {
    ...
    return (
      <div className={clsx(styles.avatar, className)} style={style}>
        <img src={src} alt="" width={size} height={size} style={style} />

        {['ledger', 'wx', 'debug'].includes(type) && (
          <div className={styles.typeIconContainer}>
            <div className={styles.typeIcon}>
              {type === 'wx' ? (
                <svg aria-hidden="true" width="14" height="14" viewBox="0 0 24 18">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                ...
                <svg aria-hidden="true" width="11" height="11" fill="#fff">
                ...
                <svg aria-hidden="true" width="20" height="20" viewBox="0 0 48 48" fill="#fff">
